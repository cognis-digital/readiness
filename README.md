...
[![PyPI](https://img.shields.io/pypi/v/cognis-readiness.svg)](https://pypi.org/project/cognis-readiness/)
[![CI](https://github.com/cognis-digital/readiness/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/readiness/actions)
...
READINESS exists for one job — compute unit readiness (c-ratings style) from a personnel/equipment/training yaml and flag gaps. — and does it without a SaaS bill or heavyweight setup.
...
```bash
readiness --version
readiness scan .                      # scan the current project
readiness scan . --format json
readiness scan . --fail-on high       # non-zero exit for CI gates
readiness mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **SORTS-style readiness**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`readiness` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
