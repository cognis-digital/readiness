#!/usr/bin/env sh
# Universal installer for readiness. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/readiness.git"
echo "Installing readiness ..."
